    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p>
            Ecomm Inc. ("us", "we", or "our") operates the Ecomm website (the
          ...
          <h2>2. Use of Data</h2>
          <p>Ecomm Inc. uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Ecomm Inc. will take all steps reasonably necessary to ensure that
          ...
          <p>
            Ecomm Inc. may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Ecomm Inc.</li>
            <li>
          ...
          <ul>
            <li>By email: privacy@ecomm.com</li>
            <li>By visiting this page on our website: www.ecomm.com/contact</li>
